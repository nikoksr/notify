...
func (ln *LineNotify) AddReceivers(receiverTokens ...string) {
...
func (ln *LineNotify) Send(ctx context.Context, subject, message string) error {
	lineMessage := subject + "\n" + message
